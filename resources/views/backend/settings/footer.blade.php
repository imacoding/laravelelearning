...
@endpush
@section('content')
    <form action="{{ route('admin.general-settings') }}" method="POST" id="general-settings-form" class="form-horizontal" enctype="multipart/form-data">
        @csrf
        ...
        <div class="card">
            ...
            <div class="card-body" id="footer">
                ...
                <div class="form-group row">
                    <label for="short_description" class="col-md-2 form-control-label">{{ __('labels.backend.general_settings.footer.short_description') }}</label>
                    <div class="col-md-8">
                        <textarea id="short_description" name="short_description" class="form-control" placeholder="{{ __('labels.backend.general_settings.footer.short_description') }}"></textarea>
                    </div>
                    <div class="col-md-2">
                        <p style="line-height: 35px">
                            <span class="mr-2">{{ __('labels.backend.general_settings.contact.show') }}</span>
                            <label class="switch switch-sm switch-3d switch-primary">
                                <input type="checkbox" class="switch-input status" value="1" checked="checked">
                ...
                @for($i=1; $i<=3; $i++)
                    <div class="form-group row">
                        <label for="section{{ $i }}" class="col-md-2 form-control-label">{{ __('labels.backend.general_settings.footer.section_'.$i) }}</label>
                        <div class="col-md-8 options">
                            <div class="row">
                                <div class="col-4">
                                    <label class="switch switch-sm switch-3d switch-success">
                                        <input type="radio" name="section{{ $i }}" class="switch-input section{{ $i }}" value="1" checked="checked">
                                        <span class="switch-label"></span>
                                        <span class="switch-handle"></span>
                                    </label>
                                ...
                                <div class="col-4">
                                    <label class="switch switch-sm switch-3d switch-success">
                                        <input type="radio" name="section{{ $i }}" class="switch-input section{{ $i }}" value="2">
                                        <span class="switch-label"></span>
                                        <span class="switch-handle"></span>
                                    </label>
                                ...
                                <div class="col-4">
                                    <label class="switch switch-sm switch-3d switch-success">
                                        <input type="radio" name="section{{ $i }}" class="switch-input section{{ $i }}" value="3">
                                        <span class="switch-label"></span>
                                        <span class="switch-handle"></span>
                                    </label>
                                ...
                                <div class="col-4">
                                    <label class="switch switch-sm switch-3d switch-success">
                                        <input type="radio" name="section{{ $i }}" class="switch-input section{{ $i }}" value="4">
                                        <span class="switch-label"></span>
                                        <span class="switch-handle"></span>
                                    </label>
                                ...
                                <div class="col-4">
                                    <label class="switch switch-sm switch-3d switch-success">
                                        <input type="radio" name="section{{ $i }}" class="switch-input custom_links section{{ $i }}" value="5">
                                        <span class="switch-label"></span>
                                        <span class="switch-handle"></span>
                                    </label>
                ...
                <div class="form-group row">
                    <label for="social_link_url" class="col-md-2 form-control-label">{{ __('labels.backend.general_settings.footer.social_links') }}</label>
                    <div class="col-md-4">
                        <input type="text" id="social_link_url" name="social_link_url" class="form-control" placeholder="{{ __('labels.backend.general_settings.footer.link_url') }}">
                    ...
                    <div class="col-md-2">
                        <button type="button" class="btn btn-block btn-light add-social-link border">{{ trans('strings.backend.general.app_add')}} <i class="fa fa-plus"></i></button>
                    </div>
                    <div class="col-md-2">
                        <p style="line-height: 35px">
                            <span class="mr-2">{{ __('labels.backend.general_settings.contact.show') }}</span>
                ...
                <div class="form-group row">
                    <label for="newsletter_form" class="col-md-2 form-control-label">{{ __('labels.backend.general_settings.footer.newsletter_form') }}</label>
                    <div class="col-md-2">
                        <p style="line-height: 35px">
                            <span class="mr-2">{{ __('labels.backend.general_settings.contact.show') }}</span>
                            <label class="switch switch-sm switch-3d switch-primary newsletter-form status">
                                <input type="checkbox" class="switch-input" value="1" checked="checked">
                                <span class="switch-label"></span>
                                <span class="switch-handle"></span>
                            </label>
                        </p>
                ...
                <div class="form-group row">
                    <label for="newsletter_form" class="col-md-2 form-control-label">{{ __('labels.backend.general_settings.footer.bottom_footer') }}</label>
                    <div class="col-md-10">
                        <p style="line-height: 35px">
                            <span class="mr-2">{{ __('labels.backend.general_settings.contact.show') }}</span>
                            <label class="switch switch-sm switch-3d switch-primary bottom-footer status">
                                <input type="checkbox" class="switch-input" value="1" checked="checked">
                                <span class="switch-label"></span>
                                <span class="switch-handle"></span>
                            </label>
                ...
                <div class="form-group row">
                    <label for="copyright_text" class="col-md-2 form-control-label">{{ __('labels.backend.general_settings.footer.copyright_text') }}</label>
                    <div class="col-md-8">
                        <input type="text" id="copyright_text" name="copyright_text" class="form-control" placeholder="{{ __('labels.backend.general_settings.footer.copyright_text') }}">
                    </div>
                    <div class="col-md-2">
                        <p style="line-height: 35px">
                            <span class="mr-2">{{ __('labels.backend.general_settings.contact.show') }}</span>
                            <label class="switch switch-sm switch-3d switch-primary">
                                <input type="checkbox" class="switch-input status" value="1">
                                <span class="switch-label"></span>
                                <span class="switch-handle"></span>
                            </label>
                        </p>
                ...
                <div class="form-group row">
                    <label for="footer_links" class="col-md-2 form-control-label">{{ __('labels.backend.general_settings.footer.footer_links') }}</label>
                    <div class="col-md-4">
                        <input type="text" id="footer_link_url" name="footer_link_url" class="form-control" placeholder="{{ __('labels.backend.general_settings.footer.link_url') }}">
                        <span class="error text-danger"></span>
                    </div>
                    <div class="col-md-2">
                        <input type="text" id="footer_link_label" name="footer_link_label" class="form-control" placeholder="{{ __('labels.backend.general_settings.footer.link_label') }}">
                    </div>
                    <div class="col-md-2">
                        <button type="button" class="btn btn-block btn-light add-footer-link border">{{ trans('strings.backend.general.app_add')}} <i class="fa fa-plus"></i></button>
                    </div>
                    <div class="col-md-2">
                        <p style="line-height: 35px">
                            <span class="mr-2">{{ __('labels.backend.general_settings.contact.show') }}</span>
                ...
                <div class="form-group row">
                    <label for="image" class="col-md-2 form-control-label">{{ __('labels.backend.general_settings.footer.footer_logo') }}</label>
                    <div class="col-md-10">
