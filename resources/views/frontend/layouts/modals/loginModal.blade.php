                        ...
                        <div class="tab-pane container fade" id="register">
                            ...
                            <form id="registerForm" class="contact_form"
                                ...
                                <div class="contact-info mb-2">
                                    ...
                                    <input type="text" name="first_name" class="form-control mb-0" placeholder="{{ __('validation.attributes.frontend.first_name') }}" maxlength="191">
                                    <span id="first-name-error" class="text-danger"></span>
                                </div>
                                <div class="contact-info mb-2">
                                  <input type="text" name="last_name" class="form-control mb-0" placeholder="{{ __('validation.attributes.frontend.last_name') }}" maxlength="191">
                                    <span id="last-name-error" class="text-danger"></span>

                                </div>

                                <div class="contact-info mb-2">
                                 <input type="email" name="email" class="form-control mb-0" placeholder="{{ __('validation.attributes.frontend.email') }}" maxlength="191">
<span id="email-error" class="text-danger"></span>

<input type="password" name="password" class="form-control mb-0" placeholder="{{ __('validation.attributes.frontend.password') }}">
<span id="password-error" class="text-danger"></span>

<input type="password" name="password_confirmation" class="form-control mb-0" placeholder="{{ __('validation.attributes.frontend.password_confirmation') }}">
