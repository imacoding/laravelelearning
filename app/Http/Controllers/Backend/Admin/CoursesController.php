...
public function store(StoreCoursesRequest $request)
{
    ...
    if ($request->media_type != "") {
        ...
        if (($request->media_type == 'youtube') || ($request->media_type == 'vimeo')) {
          ...
          //  dd($requestoriginal->hasFile('video_file'));
// ...
...
if ($requestoriginal->hasFile('video_file')) {
    $file = $requestoriginal->file('video_file');
    $filename = time() . '-' . $file->getClientOriginalName();
    $path = 'uploads'; // Relative path within the storage directory
