...
class CoursesController extends Controller
{
    ...
    public function show($course_slug)
    {
       ...
       // dd($course->id);
        ...
        return view( $this->path.'.courses.course', compact('course', 'review', 'purchased_course', 'recent_news', 'course_rating', 'completed_lessons','total_ratings','is_reviewed','lessons','continue_course'));
    }
